...
StackLL class: 
Implements stack functionality using a linked list with a head pointer representing the top of the stack.

Interface1:

Defines the stack operations (Push, Pop, Peek, IsEmpty, Size).
